...
static unsigned long intRFtime = 600000L;                                  // Call rf12_initialize every 10min to restore RF http://openenergymonitor.org/emon/node/5549 (changed to ulong to avoid truncating)
//-------------------------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------------------------
